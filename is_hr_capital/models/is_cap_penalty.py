...
class HrViolationType(models.Model):
    ...
    deduction_type = fields.Selection([('day','Day'),('hour','hour')])
...
class HrEmpPenalty(models.Model):
    ...
    job_id = fields.Many2one('hr.job', readonly=True, string="Job Position", related="employee_id.job_id")
    ...
    state = fields.Selection(
        [('draft', 'Draft'), ('clarification', 'Clarification'), ('dm', 'Department Approved'), ('hr', 'Hr Manager Approved'),
