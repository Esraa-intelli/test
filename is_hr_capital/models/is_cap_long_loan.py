    ...
    def _loan_line_installment(self):
        for x in self:
            ...
            for loan in short_loan_ids:
                ...
                installment_loan_date = datetime.strptime(str(x.paid_date), DATETIME_FORMAT)
            ...
            if x.paid_amount > x.loan_id.emp_salary * 50 / 100:
                raise Warning(_("Monthly Loan Cannot Exceed 50% of The Employee's Salary!"))
    ...
    def _loan_line_date(self):
        for x in self:
            ...
            if installment_loan_date.year > loan_date.year:
                raise Warning(_("Monthly Loan Cannot Exceed This Year!"))
